<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="index.html" class="site_title"> <span>CAFÉ ODEBRECHT</span></a>
    </div>
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a href="aa"><i class="fa fa-users"></i> Clientes </a></li>
          <li><a href="a"><i class="fa fa-male"></i> Vendedores </a></li>
          <li><a href="b"><i class="fa fa-coffee"></i> Produtos </a></li>
          <li><a><i class="fa fa-users"></i> Pedidos <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="c">Novo Pedido</a></li>
              <li><a href="d">Teste</a></li>
